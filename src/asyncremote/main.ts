 ...
 */
export interface IAsyncRemoteMain {
  /**
...
class MainRemote implements IAsyncRemoteMain {
  ...
  private _executeMethod(
    ...
    data: Utils.IMethodExecuteRequest<any>
  ): void {
    let responseChannel = Utils.makeResponseChannel(
      data.methodId,
      data.messageId
    );
...
export let asyncRemoteMain = asyncRemote;
