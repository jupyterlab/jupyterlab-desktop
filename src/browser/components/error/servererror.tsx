    ...
    return (
        <div className='jpe-ServerError-body'>
            <div className='jpe-ServerError-content'>
                ...
                <p className='jpe-ServerError-subhead'>We were unable to launch a Jupyter server, which is a prerequisite for JupyterLab Native. If Jupyter is already installed, but it is not in your PATH, specify its location below. Otherwise, try installing or updating Jupyter. The Jupyter notebook version should be 4.3.0 or greater.</p>
